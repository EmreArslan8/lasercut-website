...
import { materialDensities, materialUnitPrices, laborCosts } from "@/constants/materials";
...
export const calculatePrice = async (stepData: {
  ...
  if (extraServices && (extraServices.includes("welding") || extraServices.includes("painting"))) {
    console.log("🔔 Kaynak veya Boya seçildi. Fiyat bilgisi siparişten sonra verilecek.");
    return { 
      priceTL: "Fiyat bilgisi siparişten sonra verilecek", 
      priceUSD: "Fiyat bilgisi siparişten sonra verilecek" 
    };
  }
